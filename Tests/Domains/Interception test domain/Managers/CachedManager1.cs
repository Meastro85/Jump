...
using TestObject = Tests.Domains.Interception_test_domain.Domain.TestObject;
...
public class CachedManager1
{
    ...
    public virtual TestObject CacheItemWithId(int id)
    {
        TestObject[] items =
        [
            new("Cached object 1", "This is the first object in the list."),
            new("Cached object 2", "This is the second object in the list.")
        ];
        return items[id - 1];
    }
